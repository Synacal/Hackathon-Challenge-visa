...
const Applications = () => {
  const [applications, setApplications] = useState([
    { id: 1, fullName: 'Solide Manley', firstName: 'Solide', lastName: 'Manley', nationality: 'United States', sex: 'M', riskStatus: null, status: 'Pending', applicationNumber: 'VISA123456' },
    { id: 2, fullName: 'Jane Smith', firstName: 'Jane', lastName: 'Smith', nationality: 'Canada', sex: 'F', riskStatus: null, status: 'Pending', applicationNumber: 'VISA123457' },
    { id: 3, fullName: 'David Johnson', firstName: 'David', lastName: 'Johnson', nationality: 'Australia', sex: 'M', riskStatus: null, status: 'Approved', applicationNumber: 'VISA123458' },
    { id: 4, fullName: 'Emily Davis', firstName: 'Emily', lastName: 'Davis', nationality: 'United Kingdom', sex: 'F', riskStatus: null, status: 'Denied', applicationNumber: 'VISA123459' },
  ]);
        ...
        <table className="min-w-full table-auto">
          <thead>
            <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
              <th className="py-3 px-6 text-left">Application Number</th>
            ...
            {filteredApps.length > 0 ? (
              filteredApps.map((app) => (
                <tr key={app.id} className="border-b border-gray-200 hover:bg-gray-100 transition-all">
                  <td className="py-4 px-6 text-left font-medium">{app.applicationNumber}</td>
                  ...
                  <td className="py-4 px-6 text-center">
                    ...
                    {app.status !== 'Pending' && <span className="text-gray-500">{app.status}</span>}
                  </td>
                </tr>
              ))
            ) : (
